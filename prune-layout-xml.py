...
# Prune uninteresting components from LibreOffice Writer Layout XML files.

import re
from lxml import etree

infile = "Voluntary Provision of Environmental Offsets under Monopolistic Competition.xml"
outfile = "outfile.xml"
