...
class ZipFile:
    ...
    def _RealGetContents(self):
        ...
        while total < size_cd:
            ...
            flags = centdir[5]
            if self.filenameencoding is not None:
                filename = filename.decode(self.filenameencoding)
            elif flags & 0x800:
    ...
    def open(self, name, mode="r", pwd=None, filenameencoding=None):
        ...
        try:
            ...
            if filenameencoding is not None:
                fname_str = fname.decode(filenameencoding)
            elif self.filenameencoding is not None:
                fname_str = fname.decode(self.filenameencoding)
            elif zinfo.flag_bits & 0x800:
                # UTF-8 filename
